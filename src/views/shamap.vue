...
<script>
    // import adapt from '../../../static/js/adapt'
    // import tilelayer from '../../../static/js/leaflet-tilelayer-wmts-src'
    // import ChineseTmsProviders from '../../../static/js/leaflet.ChineseTmsProviders'
    // import leaflet from '../../../static/js/leaflet'
export default {
  name: 'maps',
  data () {
    return {
    ...
    methods:{
        ...
        //     })
        // },
		createMap(map, url, options){
		    /**
		     * leaflet.TileLayer.WMTS插件移植开始
		     */
		    ...
		    /**
		     * leaflet.TileLayer.WMTS插件移植结束
		     */
			const ign = new L.tileLayer.wmts(url, options)
			ign.addTo(map)
			return ign
    ...
    mounted(){
		...
		var mapurl = 'http://yfb.zjtoprs.com:18080' + '/geoserver/gwc/service/wmts';
        var wmsLayer= this.createMap(map,mapurl, {
            layer: 'oldtown:nxshdt',
